...
export default function WormholeCanvas({ intensity = 0.3 }: WormholeCanvasProps) {
  ...
  useEffect(() => {
    ...
    const stars = 20000; // More stars for better effect
    ...
    for (let i = 0; i < stars; i++) {
      const i3 = i * 3;
      const radius = 50 + Math.random() * 150; // Distribute between 50-200 units
      ...
      // Use intensity to affect star speed
    ...
    function animate() {
      ...
      for (let i = 0; i < stars; i++) {
        ...
        // Reset stars at a minimum distance of 50 units
        if (distance > 250) {
  ...
  }, [intensity]); // Add intensity to dependency array
